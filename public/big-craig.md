...
<div
		id="chat-box"
		style="margin-bottom: 1rem; display: flex; height: auto; max-height: 25rem; width: 100%; flex-direction: column; overflow-y: auto; border-radius: 0.5rem; border-width: 1px; padding: 2.5rem;">
</div>
<input
		id="user-input"
		type="text"
...
<img src="/big-craig.png" alt="It's Big Craig!" style="float: left;display:block;margin-right:2rem;" width="350" />
